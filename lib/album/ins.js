...
([
  ...
  function(module, exports, __webpack_require__) {
    ...
    var render = function render(res) {
      ...
      for (var j = 0, len2 = res.list.length; j < len2; j++) {
        ...
        for (var i = 0, len = data.link.length; i < len; i++) {
          ...
          var minSrc = 'http://una-love.oss-cn-beijing.aliyuncs.com/' +'E:/06Blog/img/Blog/assets/xinhaicheng/'+'min_photos/' +  data.link[i];
          var src = 'http://una-love.oss-cn-beijing.aliyuncs.com/' +'E:/06Blog/img/Blog/assets/xinhaicheng/'+'photos/'+ data.link[i];
    ...
    var replacer = function replacer(str) {
      var arr = str.split("/");
      return "/lib/album/assets/ins/" + arr[arr.length - 1];
    };
